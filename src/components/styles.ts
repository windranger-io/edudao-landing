...
export const HeroLogoWrapper = tw.div`flex items-start ml-4 my-8 flex-col lg:flex-row lg:place-self-start`
...
export const RoundedImage = tw.div`flex justify-center relative overflow-hidden mx-12 rounded-t-xl rounded-b-full`
export const RoundedImageButton = tw.button`text-xl z-10 w-10/12 md:w-auto absolute bottom-36 xl:bottom-24 py-2 mx-auto px-12 xl:px-12 bg-orange-primary hover:bg-orange-dark text-white rounded`
...
export const SponsorshipList = tw.ul`list-none group-hover:text-white py-4`
...
export const SponsorshipCTAButton = tw.button`font-uncut-sans font-extrabold text-xl h-14 my-4 w-full bg-orange-secondary text-dark py-2 px-4 rounded group-hover:hover:bg-orange-dark group-hover:text-white group-hover:bg-orange-primary`
...
export const HeroPrimaryButton = tw.button`text-2xl w-full my-14 py-4 px-4 lg:m-6 lg:my-14 lg:w-auto lg:px-24 bg-orange-primary hover:bg-orange-dark text-white rounded`
export const HeroSecondaryButton = tw.button`text-xl h-14 m-6 bg-orange-secondary hover:bg-orange-primary text-white py-2 px-4 rounded hidden lg:block`
