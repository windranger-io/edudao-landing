...
export const HeroPrimaryPseudoButton = tw.a`text-2xl text-center w-full inline-block my-14 py-4 px-4 lg:m-6 lg:my-14 md:w-auto md:px-24 bg-orange-primary hover:bg-orange-dark text-white rounded`
